...
namespace Lux.Domain
{
    public static class Cycle
    {
            ...
            double transitionOffset)
        {
            ...
            var shift = transitionDuration.Multiply(1 - transitionOffset);
            ...
            double transitionOffset)
        {
            ...
            var shift = transitionDuration.Multiply(transitionOffset);
            return sunrise + shift;
        }
            ...
            DateTimeOffset instant)
        {
            ...
            if (isDuringSunrise)
            {
                var progress = (instant - prevSunriseStart).Divide(transitionDuration);
            ...
            if (isDuringSunset)
            {
                var progress = (instant - prevSunsetStart).Divide(transitionDuration);
